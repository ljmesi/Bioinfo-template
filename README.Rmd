...
Here is a schema of the file structure. The file structure of this default project is heavily inspired by [SchlossLabs new_project github repository](https://github.com/SchlossLab/new_project), article by @Wilson2017 and 
